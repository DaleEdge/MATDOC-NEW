                        ...
                        <div class="blog-tags-social">
                            <div class="blog-social m-auto">
                                <div class="slider-btn d-flex">
                                    <a href="#" target="_blank" class="btn btn-blue btn-hover-heading-color"
                                        style="margin-right: 10px;"> <i class="fa fa-telegram" aria-hidden="true"></i>
                                        Join Telegram </a>
                                    <a href="#" target="_blank" class="btn btn-success btn-hover-heading-color"
                                        style="margin-right: 10px;"> <i class="fa fa-whatsapp" aria-hidden="true"></i>
                                        Join Whatsapp</a>
                                    <a href="" target="_blank" class="btn btn-danger btn-hover-heading-color"> <i
                                            class="fa fa-youtube-play" aria-hidden="true"></i> Join Youtube </a>
                                </div>
                            </div>
                        </div>
                    </div>
