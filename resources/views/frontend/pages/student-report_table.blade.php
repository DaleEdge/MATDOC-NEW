                               ...
                               <div class="table-responsive">
                                 <table class="table">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          <td>
                                              <form action="{{route('student_report_closing_rank_details')}}" method="POST">
                                                  @csrf()
                                                  <input type="hidden" name="course" value="{{json_encode($input['branch'])}}">
                                       ...
                                       <tr>
                                          <td>
                                               <form action="{{route('student_report_closing_rank_details')}}" method="POST">
                                                  @csrf()
                                                  <input type="hidden" name="course" value="{{json_encode($input['branch'])}}">
                                                    <input type="hidden" name="state" value="all_indias">
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>MCC All India , DNB, DEEMED, Diploma </td>
                                       </tr>
