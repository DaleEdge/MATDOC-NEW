  ...
  $(document).on('click', '.cr', function (event) {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        html += '<thead><tr><th>Round</th><th>Quota</th><th>Category</th><th>State</th><th>Institute</th><th>Course</th><th>Seats</th><th>Fee</th><th>Beds</th><th>All India Rank</th></tr></thead><tbody>';
        if (data.length) {
        ...
        $('#seatMatrixDetailsModal').modal("show"); // Show the modal
        $('#seatMatrixDetailsModalBody').html(html); // Populate the modal body with the HTML
      },
