                ...
                <div class="shadow custom-accordion-border card">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-md-3 mt-3">
                                <div class="form-group">
                                    <label for="course">Quota :</label>
                                    <select class="form-control  select2" name="quota[]" id="quota" tabindex="-1"
                                        aria-hidden="true"  onchange="filter_data()"  multiple>
                                ...
                                <div class="card mt-3 home-card">
                                    <div class="border-0 card">
                                        <div class="card-body p-0" id="table">
                                            @include('frontend.pages.bond-details_table')
                                        </div>
                                    </div>
                                </div>
                            </div>
