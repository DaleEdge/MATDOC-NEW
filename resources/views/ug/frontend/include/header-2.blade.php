                ...
                <div class="header-top-info">
                    <ul>
                        <li><span><i class="fa fa-volume-control-phone"></i> <a
                                    href="tel:+91-9686337108">+91-9686337108</a></span> </li>
                        <li><span><i class="fa fa fa-whatsapp"></i> <a href="9591692952"
                                    target="_blank">+91-9591692952</a></span> </li>
                        <li><span><i class="fa fa-envelope-o"></i> <a href="mailto:careermedia365@gmail.com"
                                    target="_blank">careermedia365@gmail.com</a></span> </li>
                    </ul>
                </div>
        ...
        <div class="container mt-3 mb-2">
            <div class="bg-custom-theme">
                <ul class="navbar-navs list">
                    ...
                    <li class="nav-item">
                        <a @if (empty(optional(Auth::user()->payment)->user_id))
                        href="{{route('subscription_plans')}} @else href=" {{route('student_report')}} @endif"
