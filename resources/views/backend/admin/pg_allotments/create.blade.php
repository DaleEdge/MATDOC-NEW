...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
            <form method="POST" action="{{route('pg_allotments.store')}}" enctype="multipart/form-data" id="valid_form">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Degree</label>
                                <input type="text" name="degree" placeholder="Enter Degree" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="bond_years" placeholder="Enter Bond Years"
                                    class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Bond Penality</label>
                                <input type="number" name="bond_penalty" placeholder="Enter Bond Penality"
                                    class="form-control">
                            </div>
                        </div>
