...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-info">
                <form method="POST" action="{{route('collage.store')}}" enctype="multipart/form-data" id="valid_form" >
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" placeholder="Enter Collage Name" class="form-control"  >
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="summernote" name="collage_description">
                                </textarea>
                            </div>
                        </div>
