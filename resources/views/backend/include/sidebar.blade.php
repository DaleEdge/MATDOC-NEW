<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        <img src="{{asset('front_css/assets/images/logo.png')}}" alt="NEET PG Counseling Logo" class="brand-image">
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('collage.index') }}"
                        class="nav-link @if (Route::currentRouteName() == 'collage.index') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('all_enquiry') }}"
                        class="nav-link @if (Route::currentRouteName() == 'all_enquiry') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('all_contact') }}"
                        class="nav-link @if (Route::currentRouteName() == 'all_contact') active @endif">
