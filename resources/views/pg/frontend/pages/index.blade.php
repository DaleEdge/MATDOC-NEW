		...
		<div class="row justify-content-center align-items-center">
			<div class="col-md-6 col-sm-8 m_hide">
				...
				<div class="slider-images">
					<div class="image"> <img src="{{asset('front_css/assets/images/hero-1.png')}}" alt="NEET PG Counselling"> </div>
				</div>
				<!-- Slider Images End -->
			</div>
			<div class="col-md-6">
				...
				<div class="slider-content">
                        <h2 class="title">Your One Stop Solution for NEET PG Counselling</h2>
					...
					<a href="#" target="_blank" class="btn btn-blue btn-hover-heading-color br_rad" style="margin-right: 10px;"> <i class="fa fa-telegram" aria-hidden="true"></i> Join NEET PG Telegram Group</a>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="single-banner">
						<div class="banner-images"> <img src="{{asset('front_css/assets/images/banner-01.jpg')}}" alt="NEET PG Counselling"> </div>
		...
		<div class="counter-wrapper">
			...
			<div class="row row-cols-2 row-cols-sm-4">
				<div class="col">
					...
					<div class="single-counter">
						<div class="counter-box">
							<div class="counter-icon"> <img src="{{asset('front_css/assets/images/icon-1.png')}}" alt="NEET PG Counselling"> </div>
				...
				<div class="col">
					...
					<div class="single-counter">
						<div class="counter-box">
							<div class="counter-icon"> <img src="{{asset('front_css/assets/images/icon-2.png')}}" alt="NEET PG Counselling"> </div>
				...
				<div class="col">
					...
					<div class="single-counter">
						<div class="counter-box">
							<div class="counter-icon"> <img src="{{asset('front_css/assets/images/icon-3.png')}}" alt="NEET PG Counselling"> </div>
				...
				<div class="col">
					...
					<div class="single-counter">
						<div class="counter-box">
							<div class="counter-icon"> <img src="{{asset('front_css/assets/images/icon-4.png')}}" alt="NEET PG Counselling"> </div>
		...
		<div class="blog-wrapper">
			<div class="row">
				<div class="col-lg-6 col-sm-6">
					...
					<div class="single-course">
						<div class="courses-image">
							<a href="course-details.html"><img src="{{asset('front_css/assets/images/blog/blog-1.png')}}" alt="NEET PG Counselling 2022"></a>
						</div>
				...
				<div class="col-lg-6 col-sm-6">
					...
					<div class="single-course">
						<div class="courses-image">
							<a href="course-details.html"><img src="{{asset('front_css/assets/images/blog/blog-2.png')}}" alt="NEET PG Counselling 2022"></a>
						</div>
						<div class="courses-content">
				...
				<div class="col-lg-6 col-sm-6">
					...
					<div class="single-course">
						<div class="courses-image">
							<a href="course-details.html"><img src="{{asset('front_css/assets/images/blog/blog-3.png')}}" alt="NEET PG Counselling 2022"></a>
						</div>
						<div class="courses-content">
				...
				<div class="col-lg-6 col-sm-6">
					...
					<div class="single-course">
						<div class="courses-image">
							<a href="course-details.html"><img src="{{asset('front_css/assets/images/blog/blog-4.png')}}" alt="NEET PG Counselling 2022"></a>
						</div>
						<div class="courses-content">
...
<div class="section section-padding pt-0 mb-3">
	<div class="container">
		<!-- Section Title Start -->
		<div class="section-title text-center">
			<h2 class="title"><span>The NEET PG Counselling</span> </h2> </div>
		<!-- Section Title End -->
	</div>
	<!-- Pricing Wrapper End -->
