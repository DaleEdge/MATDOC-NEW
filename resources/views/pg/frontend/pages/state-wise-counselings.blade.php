                              ...
                              <div class="row">
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        ...
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=andhra_pradeshes')}}" style="background:#1ee99e;">
                                    ...
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=assams')}}" style="background:#e91e63;">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        ...
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=bihars')}}" style="background:#ffc107;">
                                    ...
                                    <!--<div class="col-lg-2 col-sm-6 col-xs-6">-->
                                        <!-- Category Item Start -->
                                    <!--    <div class="single-category-items">-->
                                    <!--        <a href="{{route('pg.state_wise_counseling_details','state=chandigarhs')}}" style="background:rgb(20, 240, 68);">-->
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=chhattisgarhs')}}" style="background:rgb(105 115 205);">
                                     ...
                                     <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=gujarats')}}" style="background:rgb(199 112 201);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=haryanas')}}" style="background:rgb(109 183 225);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=himachal_pradeshes')}}" style="background:#009688;">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=jammu_and_kashmirs')}}" style="background:rgb(67, 169, 228);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=jharkhands')}}" style="background:rgba(58, 129, 85, 0.555);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=karnatakas')}}" style="background:rgb(189 213 55);">
                                    ...
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=keralas')}}" style="background:rgb(35 88 167 / 67%);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=madhya_pradeshes')}}" style="background:rgb(88, 128, 109);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=maharashtras')}}" style="background:rgb(124, 230, 75);">
                                    ...
                                    <!--<div class="col-lg-2 col-sm-6 col-xs-6">-->
                                        <!-- Category Item Start -->
                                    <!--    <div class="single-category-items">-->
                                    <!--        <a href="{{route('pg.state_wise_counseling_details','state=manipurs')}}" style="background:rgba(36, 53, 63, 0.527);">-->
                                    ...
                                    <!--<div class="col-lg-2 col-sm-6 col-xs-6">-->
                                        <!-- Category Item Start -->
                                    <!--    <div class="single-category-items">-->
                                    <!--        <a href="{{route('pg.state_wise_counseling_details','state=meghalayas')}}" style="background:rgb(166, 93, 248);">-->
                                    ...
                                    <!--<div class="col-lg-2 col-sm-6 col-xs-6">-->
                                        <!-- Category Item Start -->
                                    <!--    <div class="single-category-items">-->
                                    <!--        <a href="{{route('pg.state_wise_counseling_details','state=odishas')}}" style="background:rgba(116, 34, 34, 0.479);">-->
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=pondicherries')}}" style="background:rgb(205 189 51);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=punjabs')}}" style="background:rgb(49 166 171);">
                                    ...
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=rajasthans')}}" style="background:rgb(191 156 79);">
                                    ...
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=tamil_nadus')}}" style="background:rgba(4, 58, 87, 0.459);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=telanganas')}}" style="background:rgb(70, 167, 223);">
                                    ...
                                    {{-- <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=tripuras')}}" style="background:rgb(2 116 59 / 68%);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=uttar_pradeshes')}}" style="background:rgb(80 86 21);">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=uttarakhands')}}" style="background:#607d8b;">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-6">
                                        <!-- Category Item Start -->
                                        <div class="single-category-items">
                                            <a href="{{route('pg.state_wise_counseling_details','state=west_bengals')}}" style="background:rgb(86, 43, 240);">
