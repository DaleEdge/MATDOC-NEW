...
namespace App\Http\Controllers\pg\Front;
...
class pgFrontController extends Controller
{
    ...
    {
        return view('pg.frontend.pages.home');
    }
    public function contact()
    {
        return view('pg.frontend.pages.contact');
    }

    public function subscription_plans()
    {
        return view('pg.frontend.pages.subscription-plans');
    }
    public function closing_rank(Request $request)
    {
        $state = $request->state;
        $list = DB::table('pg_neet_ranks')->orderBy('state_rank', 'asc')->take(1)->get();

        if ($request->ajax() && $state != "") {

            $list = $state == "all_indias" ? DB::table('pg_neet_ranks')->orderBy('state_rank', 'asc')->take(100)->get() : DB::table('pg_neet_ranks')->where("state", $state)->orderBy('state_rank', 'asc')->take(100)->get();

            return view('pg.frontend.pages.closing-rank_table', compact('state', 'list'));
        }

        return view('pg.frontend.pages.closing-rank', compact('state', 'list'));
    }
    public function closing_rank_details(Request $request)
    {
        $state = $request->state;
        $counseling_type = $request->counseling_type;
        $list = DB::table('pg_' . $state)->orderBy('id');
        $college = DB::table('pg_' . $state)->groupBy('college')->get();
        $category = DB::table('pg_' . $state)->groupBy('category')->get();
        ...
        if ($request->ajax()) {
            return view('pg.frontend.pages.closing-rank-details_table', compact('list', 'college', 'category', 'round'));
        }

        return view('pg.frontend.pages.closing-rank-details', compact('list', 'college', 'category', 'round'));
    }
    public function all_india_counselings(Request $request)
    {
        return view('pg.frontend.pages.all-india-counselings');
    }
    public function state_wise_counselings()
    {
        return view('pg.frontend.pages.state-wise-counselings');
    }
    public function state_wise_counseling_details()
    {
        return view('pg.frontend.pages.state-wise-counseling-details');
    }
    public function about_us()
    {
        return view('pg.frontend.pages.about-us');
    }
    public function term_condition()
    {
        return view('pg.frontend.pages.term-and-condition');
    }
    public function privacy_policy()
    {
        return view('pg.frontend.pages.privacy-policy');
    }
    ...
    public function login()
    {
        if (Auth::check()) {
            ...
            return view('pg.frontend.auth.login');
        }
    }
    public function register()
    {
        if (Auth::check()) {
            ...
            return view('pg.frontend.auth.register');
        }
    }
    ...
    public function user_dashboard()
    {
        ...
        if (Auth::check()) {
            return view('pg.frontend.user.profile');
        }
        return redirect()->route('user-login');
    }
    ...
    function forgot_password(Request $request)
    {
        if (Auth::check()) {
            ...
            return view('pg.frontend.auth.forgot-password');
        }
    ...
    public function bond_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.bond-details_table', compact('list', 'college', 'course', 'quota', 'category', 'round'));
        }

        return view('pg.frontend.pages.bond-details', compact('list', 'college', 'course', 'quota', 'category', 'round'));
    }
    ...
    public function stipend_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.stipend-details_table', compact('list', 'college', 'course', 'quota', 'category', 'round'));
        }

        return view('pg.frontend.pages.stipend-details', compact('list', 'college', 'course', 'quota', 'category', 'round'));
    }
    ...
    public function fee_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.fee-details_table', compact('list', 'college', 'category', 'round'));
        }

        return view('pg.frontend.pages.fee-details', compact('list', 'college', 'category', 'round'));
    }
    ...
    public function all_india_stipend_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.all-stipend-details_table', compact('list', 'college', 'course', 'quota', 'category', 'round'));
        }

        return view('pg.frontend.pages.all-stipend-details', compact('list', 'college', 'course', 'quota', 'category', 'round'));
    }
    ...
    public function all_india_fee_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.all-fee-details_table', compact('list', 'college', 'category'));
        }

        return view('pg.frontend.pages.all-fee-details', compact('list', 'college', 'category'));
    }
    ...
    public function all_india_closing_rank_details(Request $request)
    {
        ...
        $list = $list->paginate(100);
        if ($request->ajax()) {
            return view('pg.frontend.pages.all-india-closing-rank-details_table', compact('list', 'college', 'category', 'round'));
        }

        return view('pg.frontend.pages.all-india-closing-rank-details', compact('list', 'college', 'category', 'round'));
    }

    public function student_report(Request $request)
    {

        return view('pg.frontend.pages.student-report');
    ...
    public function student_report_details(Request $request)
    {
        ...
        $input = $request->all();
        return view('pg.frontend.pages.student-report_table', compact('counselling_preference', 'input'));
    ...
    public function student_report_closing_rank_details(Request $request)
    {
        ...
        if ($request->type == 'all') {
            $list = DB::table('pg_' . $state)->where('tuition_fees', '<', $request->budget)->orderBy('id');
            $category = DB::table('pg_' . $state)->groupBy('category')->get();
            $college = DB::table('pg_' . $state)->groupBy('college')->get();

        }
        if ($request->type == 'deemed') {
            $list = DB::table('pg_' . $state)->where('tuition_fees', '<', $request->budget)->where(function ($query) use ($request) {
                $query->where('category', 'MNG');
            })->orderBy('id');
            $category = DB::table('pg_' . $state)->where(function ($query) use ($request) {
                $query->where('category', 'MNG');
            })->get();
            $college = DB::table('pg_' . $state)->where(function ($query) use ($request) {
                $query->where('category', 'MNG');
            })->groupBy('college')->get();
        ...
        if ($request->type == 'state_home') {
            ...
            if (!empty($request->submit)) {
                $pdf = PDF::loadView('pg.frontend.pages.student-report-closing-rank-details_download', compact('list', 'category', 'round', 'state', 'type', 'rank', 'budget', 'college'));
                return $pdf->download('sdfsf.pdf');
            }
            $list = $this->paginate($new_array);
            if ($request->ajax()) {
                return view('pg.frontend.pages.student-report-closing-rank-details_table', compact('list', 'category', 'round', 'state', 'type', 'rank', 'budget', 'college'));
            }
            return view('pg.frontend.pages.student-report-closing-rank-details', compact('list', 'category', 'round', 'state', 'type', 'rank', 'budget', 'college'));
    ...
    public function mark_vs_rank(Request $request)
    {
        ...
        return view('pg.frontend.pages.mark_vs_rank', compact('data'));
...
//               }
    ...
    //       $list=$this->paginate($new_array);
//   if($request->ajax()){
//     return view('pg.frontend.pages.student-report-closing-rank-details_table',compact('list','category','quota','round','state','type','rank','budget','cour','college'));
//     }
//       return view('pg.frontend.pages.student-report-closing-rank-details',compact('list','category','quota','round','state','type','rank','budget','cour','college'));
...
//             $list=$list->where(function($query) use ($request) {
//                             $query->where('quota','PY Mgmt-Chris.Min')->orwhere('quota','PY Mgmt-Open')->orwhere('quota','PY Mgmt-TelpguMin');
//                 });
//           }
//           if($state=='rajasthans'){
//             $list=$list->where(function($query) use ($request) {
...
//               }
    ...
    //         $pdf = PDF::loadView('pg.frontend.pages.student-report-closing-rank-details_download',compact('list','category','quota','round','state','type','rank','budget','cour','college'));
//         return $pdf->download('sdfsf.pdf');
    ...
    //         return redirect()->route('user_dashboard');
    //     }
    //     return view('pg.frontend.auth.signup');
    // }
...
//         return view('pg.frontend.user.accountReview',compact('user'));
//     }
    ...
    public function get_college_hospital(Request $request)
    {
        ...
        return view('pg.frontend.pages.college-hospital');
    ...
    public function deemed_hospital_details(Request $request)
    {
        ...
        return view('pg.frontend.pages.deemed-college-hospital');
    ...
    public function get_college_hospital_detail(Request $request)
    {
        ...
        return view('pg.frontend.pages.college-hospital-detail', compact('list'));
    ...
    public function seat_matrix(Request $request)
    {
        ...
        if ($request->ajax() && $state != "") {
            ...
            return view('pg.frontend.pages.seat-matrix_table', compact('state', 'list'));
        }

        return view('pg.frontend.pages.seat-matrix', compact('state', 'list'));
    }
    ...
    public function fees_stipend_bond(Request $request)
    {
        ...
        if ($request->ajax() && $state != "") {
            ...
            return view('pg.frontend.pages.fees-stipend-bond_table', compact('state', 'list'));
        }

        return view('pg.frontend.pages.fees-stipend-bond', compact('state', 'list'));
    }
