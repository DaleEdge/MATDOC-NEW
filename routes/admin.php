...
use App\Http\Controllers\UgAllotmentsController;
use App\Http\Controllers\PgAllotmentsController;
...
Route::group(['middleware' => ['auth', 'can:accessAdminpanel']], function () {
    ...
    Route::resource('ug_allotments', UgAllotmentsController::class);
    Route::resource('pg_allotments', PgAllotmentsController::class);
